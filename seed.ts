...
const EVENTS: EventSeed[] = [
  { id: 1, cat: "faith", title: "Dhul Hijjah moon sighted; Eid al-Adha date confirmed across Gulf states", country: "Saudi Arabia", lat: 24.47, lon: 39.61, sev: "medium", t: now - 1 * H,
  ...
  { id: 2, cat: "humanitarian", title: "Flash floods displace 40,000 in Sindh; relief convoys en route", country: "Pakistan", lat: 26.06, lon: 68.94, sev: "critical", t: now - 0.233 * H,
  ...
  { id: 3, cat: "conflict", title: "Aid corridor into northern Gaza reopens after week-long closure", country: "Palestine", lat: 31.53, lon: 34.45, sev: "critical", t: now - 0.05 * H,
  ...
  { id: 4, cat: "humanitarian", title: "Cholera alert in displacement camps around El Fasher", country: "Sudan", lat: 13.63, lon: 25.35, sev: "high", t: now - 24 * H,
  ...
  { id: 16, cat: "good_news", title: "3,200 people took shahada at a single Istanbul da'wah event this weekend", country: "Turkey", lat: 41.01, lon: 28.98, sev: "low", t: now - 120 * H,
    what: "Organisers of a three-day outreach event in Istanbul recorded 3,200 individual conversions to Islam, the largest single gathering of its kind reported in the city this year.",
    why: "Da'wah organisations point to rising interest across Europe; large in-person conversion events are rare enough that verified counts get significant attention.",
    status: "Organisers publishing verified names/photos with consent over the coming week; independent journalists on site corroborate the headline figure.",
    keywords: ["shahada", "dawah", "istanbul", "conversion", "good news"],
    timeline: [["3d ago", "Event opens"], ["1d ago", "Daily conversion counts published"], ["8h ago", "Final day count confirmed"]],
    sources: [["Anadolu Agency", true], ["TRT World", true]], rel: [1] },
  { id: 17, cat: "good_news", title: "São Paulo's first purpose-built masjid opens after 12-year community campaign", country: "Brazil", lat: -23.55, lon: -46.63, sev: "low", t: now - 30 * H,
    what: "Brazil's fast-growing Muslim community celebrated the opening of São Paulo's first purpose-built masjid, funded entirely through 12 years of local fundraising.",
    why: "Latin America's Muslim population is small but growing quickly; a purpose-built (not converted) masjid is a rare and significant milestone for the community's visibility and permanence.",
    status: "Masjid operational; daily prayers and a weekend Islamic school now running on site.",
    keywords: ["brazil", "masjid", "sao paulo", "community", "good news"],
    timeline: [["12y ago", "Fundraising campaign begins"], ["30h ago", "Grand opening ceremony"]],
    sources: [["Folha de S.Paulo", true], ["Latin America Muslim News", false]], rel: [13] },
  { id: 18, cat: "good_news", title: "Global Qur'an memorisation competition crowns 14-year-old from Chad", country: "Egypt", lat: 30.04, lon: 31.24, sev: "low", t: now - 14 * H,
    what: "A 14-year-old from Chad won the international Qur'an memorisation and recitation competition in Cairo, competing against contestants from over 90 countries.",
    why: "The competition is one of the largest of its kind; a winner from a country rarely represented on the podium is being celebrated widely across West and Central African Muslim communities.",
    status: "Awards ceremony completed; winner's home community in N'Djamena planning a public celebration.",
    keywords: ["quran", "competition", "chad", "cairo", "good news"],
    timeline: [["2d ago", "Finals begin"], ["14h ago", "Winner announced"]],
    sources: [["Al-Azhar Al-Sharif", true], ["Chad National Radio", false]], rel: [5] },
];
